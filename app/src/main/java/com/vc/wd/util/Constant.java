...
public class Constant {
    ...
    public final static String ACTIVITY_URL_MAIN = "/login/MainActivity";
    public final static String ACTIVITY_URL_ADD_CIRCLE = "/login/AddCircleActivity";
    public final static String ACTIVITY_URL_SET = "/login/SetActivity";
